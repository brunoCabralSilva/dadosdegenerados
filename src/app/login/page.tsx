      ...
      <div className="bg-[url(/images/dd_logo_bg.jpg)] break-words flex flex-col items-center justify-center px-3 sm:px-6 py-8 mx-auto h-full lg:py-0">
        {
          !showData 
          ? <Loading />            
          : <div className="break-words p-1 w-full rounded-lg shadow sm:max-w-md my-5 bg-[url(/images/dd_logo_bg_black.png)]">
                  ...
                  <div className="break-words p-4 space-y-4 md:space-y-6 sm:p-8">
                    <div className="break-words space-y-4 md:space-y-6">
                      ...
                      <div>
                        ...
                        <div className="break-words border-2 border-white rounded">
                          <input 
                            type="email"
                            name="email"
                            id="email" 
                      ...
                      <div className="break-words flex items-center justify-center sm:justify-end">
                          <button
                            ...
                            className="break-words text-sm font-medium underline text-white hover:text-red-400 transition-colors cursor-pointer">
                              Esqueceu a Senha?
                          </button>
                      </div>
                      <button 
