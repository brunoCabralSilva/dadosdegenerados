...
const initialValue: DegeneratesContext = {
  ...
  setShowEditEvent: () => {},
  showEditActivity: { show: false, data: { id: '', dm: '', eventId: '', name: '', typeActivity: '', recommendedAge: 0, systemSession: { name: '', description: '' }, spots: 0, availableSpots: 0, noSpots: false, dates: [], description: '', sensibility: '' }},
